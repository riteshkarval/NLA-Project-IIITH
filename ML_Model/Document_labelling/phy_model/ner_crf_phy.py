...
data = pd.read_csv("../../../Dataset/wiki_phy_v2.csv", names = headers, encoding="latin1")
...
with open("phy_crf_model.json", "w") as text_file:
    text_file.write(json_string)
model.save_weights('phy_crf_model_weights.h5')

# Saving Vocab
with open('word_to_index_phy.pickle', 'wb') as handle:
    pickle.dump(word2idx, handle, protocol=pickle.HIGHEST_PROTOCOL)
 
# Saving Vocab
with open('tag_to_index_phy.pickle', 'wb') as handle:
