...
data = pd.read_csv("../../../Dataset/wiki_chem_v2.csv", names = headers, encoding="latin1")
...
with open("chem_crf_model.json", "w") as text_file:
    text_file.write(json_string)
model.save_weights('chem_crf_model_weights.h5')

# Saving Vocab
with open('word_to_index_chem.pickle', 'wb') as handle:
    pickle.dump(word2idx, handle, protocol=pickle.HIGHEST_PROTOCOL)
 
# Saving Vocab
with open('tag_to_index_chem.pickle', 'wb') as handle:
